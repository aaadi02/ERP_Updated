  ...
  const handleExportData = () => {
    const csvContent = "data:text/csv;charset=utf-8," + 
      ...
      payments.map(payment => 
        `${payment.receiptNumber},"${payment.studentId?.firstName} ${payment.studentId?.lastName}",${payment.studentId?.studentId},${payment.amount},${payment.paymentMethod},${formatDate(payment.paymentDate)},${payment.status},${payment.transactionId || 'N/A'}`
      ).join("\n");
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{filteredStats.totalPayments}</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-emerald-600">{filteredStats.completedPayments}</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">{filteredStats.todayPayments}</p>
                </div>
                  ...
                  <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <h4 className="font-medium text-gray-800">{method._id}</h4>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600 mb-1">{method.count} transactions</p>
                    <p className="text-lg font-bold text-green-600">₹{method.total.toLocaleString()}</p>
                  </div>
                ))}
              </div>
            </div>
