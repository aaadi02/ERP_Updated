...
const ComposeAnnouncementByPrincipal = () => {
  ...
  const roles = ["student", "teaching_staff", "non_teaching_staff", "hod", "cc"];
      ...
      <div className="max-w-7xl mx-auto relative z-0">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-gray-900 via-purple-800 to-indigo-800 bg-clip-text text-transparent mb-4">
            🎓 Principal's Announcement Dashboard
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Create and manage institutional announcements with administrative authority
          </p>
        </div>
